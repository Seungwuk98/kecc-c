...
int main() {
  ...
  for (int i = 0; i < 10; i++) {
    ...
    // CHECK-NEXT:   %b2:i1:i32* = call @foo:[ret:i32* params:(i32*)]*(%b2:i0:i32*)
    // CHECK-NEXT:   %b2:i2:i32 = load %l1:i32*
    ...
    // CHECK-NEXT:   %b2:i6:i32 = load %l1:i32*
    // CHECK-NEXT:   %b2:i7:unit = store %b2:i6:i32 %b2:i5:i32*
    // CHECK-NEXT:   j b3()
