...
// CHECK-DAG: struct %t1 : { a:u8, %anon:struct %t0, c:i64 }
typedef struct {
  char a;
  struct {
    int b[4];
...
int main() {
  ...
  // CHECK-NEXT:   %b0:i12:i64* = getelementptr %l0:const struct %t1* offset 24:i64
  // CHECK-NEXT:   %b0:i13:unit = store 6:i64 %b0:i12:i64*
  ...
  // CHECK-NEXT:   %b0:i27:i64 = typecast %b0:i26:i32 to i64
  // CHECK-NEXT:   %b0:i28:i64* = getelementptr %l1:struct %t1* offset 24:i64
  // CHECK-NEXT:   %b0:i29:i64 = load %b0:i28:i64*
  // CHECK-NEXT:   %b0:i30:i64 = add %b0:i27:i64 %b0:i29:i64
  // CHECK-NEXT:   %b0:i31:i32 = typecast %b0:i30:i64 to i32
  // CHECK-NEXT:   %b0:i32:unit = store %b0:i31:i32 %l2:i32*

  // CHECK-NEXT:   %b0:i33:i32 = load %l2:i32*
  // CHECK-NEXT:   %b0:i34:i1 = cmp eq %b0:i33:i32 11:i32
  // CHECK-NEXT:   %b0:i35:i32 = typecast %b0:i34:i1 to i32
  // CHECK-NEXT:   ret %b0:i35:i32
  return sum == 11;
}
// CHECK-NEXT: }
